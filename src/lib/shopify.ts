...
export const SHOPIFY_STORE_PERMANENT_DOMAIN = 'mirabrio-eco-blueprint-11e21.myshopify.com';
export const SHOPIFY_STOREFRONT_URL = `https://${SHOPIFY_STORE_PERMANENT_DOMAIN}/api/${SHOPIFY_API_VERSION}/graphql.json`;
export const SHOPIFY_STOREFRONT_TOKEN = '0f2e599bb9d35f288f12a2126fc44613';
...
export async function fetchCollections(limit = 20): Promise<ShopifyCollection[]> {
...
export const SHOPIFY_ACCOUNT_URLS = {
  ...
  resetPassword: `https://${SHOPIFY_STORE_PERMANENT_DOMAIN}/account/password/new`,
};
